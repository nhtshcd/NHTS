...
(function($){
	...
	$.addFlex = function(t,p)
	{
						...
						function ()
							{
									...
									if (pth.hide) $(this).css('display','');
									 
									 }
									 
									 if (p.nowrap==false) $(tdDiv).css('white-space','nowrap');
		...
		$(g.bDiv).after(g.pDiv);
		var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">Page <input type="text" size="4" name="pa"/> of <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
		...
		$('input[name=pa]',g.pDiv).keyup(function()
				{
		...
		if ($.browser.msie&&$.browser.version<7) $('.pButton',g.pDiv).hover(function(){$(this).addClass('pBtnOver');},function(){$(this).removeClass('pBtnOver');});
			...
			if (p.searchitems)
			{
				...
				// Customization DCR RT#70394 03/18/2009
				if (p.qtype=='') p.qtype = sitems[0].name;
				$(g.sDiv).append("<div class='sDiv2'><input type='button'name='runFilter' id='runFilter' value='Search' " +"class='btnLightGray'style='margin: 0 5px 0 0;float: left;'>"+ "<input type='button' name='clrFilter'id='clrFilter' value='claro' " + "class='btnLightGray'style='float: left;'></div>");
				$(g.sDiv).append("<div class='sDiv2'>" + "<span style='margin: 0 5px 0 5px;'>Find :</span> <input type='text' size='10' name='q' " + " class='qsbox " + p.queryClass + "' /> <select name='qtype' class='" + p.queryClass + "'>"+sopt+  "</select>"             
				             + "</div>");

				$('input[name=runFilter]',g.sDiv).click(function(e){g.doSearch()});
