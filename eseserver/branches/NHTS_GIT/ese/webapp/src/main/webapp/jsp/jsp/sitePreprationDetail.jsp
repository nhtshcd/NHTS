						...
						<div class="formContainerWrapper dynamic-form-con">
							...
							<s:if test='branchId==null'>
								<div class="dynamic-flexItem">
									...
									<p class="flexItem">
										<s:property value="%{getBranchName(sitePrepration.branchId)}" />
									</p>
								</div>
							</s:if>
							...
							<div class="dynamic-flexItem  y1 hide ">
								...
								<s:if test="envr!=null && envr!=''">
									<button type="button" class="fa fa-download"
										...
										onclick="popDownload(<s:property value="envr"/>)"></button></s:if>
								</p>
							</div>
...
<s:if test="socr!=null && socr!=''">
									<button type="button" class="fa fa-download"
										style="background-color: transparent"
										onclick="popDownload(<s:property value="socr"/>)"></button></s:if>
								</p>
							</div>
...
<s:if test="soir!=null && soir!=''">
									<button type="button" class="fa fa-download"
										style="background-color: transparent"
										onclick="popDownload(<s:property value="soir"/>)"></button></s:if>
								</p>
							</div>
...
<s:if test="watr!=null && watr!=''">
									<button type="button" class="fa fa-download"
										style="background-color: transparent"
										onclick="popDownload(<s:property value="watr"/>)"></button></s:if>
								</p>
							</div>
